    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <div class="sidebar-brand d-flex align-items-center justify-content-center sidebar-brand-text mx-3">Ajouter une tâche</div>
                            ...
                            <form method="post" action ="../ctrl/add_operation.action.php ">
                                <div class="col">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input id="add_operation_comment" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button id="add_operation_submit" class="btn btn-outline-secondary" type="subit">Valider</button>
                                        </div>
                                    </div>
