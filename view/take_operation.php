        ...
        <div id="wrapper" class="toggled">
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    <li> <a href="menu.php">Retour au menu</a> </li>
            ...
            <div id="page-content-wrapper">
                <div class="container-fluid row">
                    ...
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <strong>Client :</strong> <span id="take_operation_customer"></span><br>
                            <strong>Commentaire :</strong> <span id="take_operation_comment"></span><br>
                            <strong>Type d'opération :</strong> <span id="take_operation_typeoperation"></span><br>
                            <strong>Date d'enregistrement :</strong> <span id="take_operation_dateBegin"></span><br>
                        </div>
                    </div>
                    <div class="card text-center align-middle" style="width: 18rem;">
                        <div id="text-center">
                            <br><br><input id="take_operation_submit" type="submit" value="Prendre tâche">
                            <p><span id="take_operation_ok"></span></p>
                        </div>
                    </div>
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            <p>Vous pouvez encore prendre <span id="take_operation_nbTasks"></span> tâches !</p>
                        </div>
                    </div>
                </div>
