    ...
    <!-- Page Wrapper -->
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
                <div class="sidebar-brand d-flex align-items-center justify-content-center sidebar-brand-text mx-3">Ajouter un employé</div>
                            ...
                            <form method="post" action ="../ctrl/add_worker.action.php">
                                <div class="col">
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input id="add_worker_name" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-sm">Prénom :</span>
                                        </div>
                                        <input id="add_worker_surname" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                        <select id="add_worker_grade">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-sm">Identifiant :</span>
                                        </div>
                                        <input id="add_worker_login" type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="input-group input-group-sm mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-sm">Mot de passe :</span>
                                        </div>
                                        <input id="add_worker_password" type="password" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                    </div>
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-append">
                                            <button id="add_worker_submit" class="btn btn-outline-secondary" type="subit">Valider</button>
                                        </div>
                                    </div>
